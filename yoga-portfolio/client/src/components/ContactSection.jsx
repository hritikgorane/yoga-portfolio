      ...
      <div className={styles.inner}>
        <div className={`${styles.left} reveal`}>
          ...
          <div className={styles.socials}>
            ...
            <a href="https://www.instagram.com/hrithik.rh/" target="_blank" rel="noreferrer" className={styles.socialLink} aria-label="Instagram">
            ...
            <a href="https://www.youtube.com/@HritikGorane" target="_blank" rel="noreferrer" className={styles.socialLink} aria-label="YouTube">
