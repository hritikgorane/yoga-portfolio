    ...
    <main>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerSocial}>
          <a href="https://www.instagram.com/hrithik.rh/" target="_blank" rel="noreferrer" aria-label="Instagram">
          ...
          <a href="https://www.youtube.com/@HritikGorane" target="_blank" rel="noreferrer" aria-label="YouTube">
